...
<div class="ccm-page-list slick-wrapper ccm-page-list-3d" data-slick='<?php echo json_encode($options) ?>' id="slick-wrapper-<?php echo $bID?>">
	...
	<?php  foreach ($pages as $page):
		...
		<div class="slick-slide">
			<?php if ($imageTag) : ?>
			<a href="<?php  echo $url ?>" target="<?php  echo $target ?>"><?php echo $imageTag;?></a><?php endif ?>
            <?php if ($includeDate): ?>
                <div class="meta">
            ...
            <?php endif; ?>
			<a href="<?php  echo $url ?>" target="<?php  echo $target ?>" class="button-block button-flat"><?php  echo $title ?></a>
